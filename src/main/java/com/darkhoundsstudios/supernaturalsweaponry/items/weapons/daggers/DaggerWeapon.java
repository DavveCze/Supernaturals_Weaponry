...
public class DaggerWeapon extends ModWeapon {
    ...
    //vyvolá se pokud hráč klikne pravým tlačítkem na entitu
    @Override
    ...
    //vyvolá se pokud hráč hitne cíl
    @Override
    public boolean hitEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        //vypočítá se šance na způsobení krvácení, pokud již krvácení je aplikováno zvýší se mu amplifier
