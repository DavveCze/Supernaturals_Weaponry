...
public class SunlightCollectorContainer extends Container {
    private final TileEntity tileEntity;
    private final PlayerEntity player;
    private final IItemHandler playerInv;
    public SunlightCollectorContainer(int windowId, World world, BlockPos blockPos,
                                      PlayerInventory inventory, PlayerEntity _player) {
        super(ModContainers.SUNLIGHT_COLLECTOR_CONTAINER.get(), windowId);
        this.tileEntity = world.getTileEntity(blockPos);
        player = _player;
        playerInv = new InvWrapper(inventory);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(),tileEntity.getPos()),
                playerIn, RegistryHandler.SUNLIGHT_COLLECTOR.get());
    }
